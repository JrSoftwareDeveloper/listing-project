@php
    $scripts = ['admin/assets/js/page/create-listing-page.js'];
@endphp
<x-admin-layout :scripts="$scripts" :active="'listing'">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.listing.store') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">Thumbnail Image <span
